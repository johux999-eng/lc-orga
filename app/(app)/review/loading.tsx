    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 animate-pulse">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="space-y-1.5">
          ...
          <div className="h-3.5 w-40 bg-lc-border/60 rounded" />
        </div>
      </div>
          ...
          <div key={i} className="bg-lc-surface border border-lc-border rounded-xl p-4 space-y-3">
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 space-y-2">
                ...
                <div className="h-3 bg-lc-border/60 rounded w-1/2" />
              </div>
              <div className="h-5 w-20 bg-lc-hover rounded-full shrink-0" />
            </div>
            <div className="flex gap-2">
              <div className="h-8 flex-1 bg-lc-hover rounded-lg" />
              <div className="h-8 flex-1 bg-lc-hover rounded-lg" />
            </div>
          </div>
        ))}
